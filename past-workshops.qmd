...
## Preparing to Teach - JSM 2026

Boston, Massachusetts

### Speakers

Mine Çetinkaya-Rundel, Tyler George, Maria Tackett, Brianna Heggeseth, Federica Zoe Ricci, Hunter Glanz`  

### Organisers

Mine Çetinkaya-Rundel, Allison Theobold, and Claire Kelling

### Materials

Materials from PTT 2026 can be found [here](https://github.com/mine-cetinkaya-rundel/preparing-to-teach-web/tree/main/resources/ptt_2026_materials).

### Acknowledgements

This workshop was made possible with travel support from EAPOST, a meeting room sponsored by the American Statistical Association, and lunch supported by the ASA and the Section on Statistics and Data Science Education.


## Preparing to Teach - JSM 2023

Toronto, Canada

### Speakers

Mine Çetinkaya-Rundel, Mine Dougu, Jo Hardin, Claire Kelling, Colin Rundel, and Allison Theobold
...
- Session 1: Teaching-focused careers
- Session 2: Statistics and data science education research
- Session 3: Your first year as faculty / early career faculty
- Session 4: Teaching intro stats and assessing learning
- Session 5: Teaching intro data science and assessing learning
- Session 6: Equitable teaching

### Materials

Materials from PTT 2023 can be found [here](https://github.com/mine-cetinkaya-rundel/preparing-to-teach/releases/tag/ptt-2023).

### Acknowledgements

This workshop was organized by the Section on Statistics and Data Science Education of the American Statistical Association with support from the IMS New Researchers Conference.

------------------------------------------------------------------------

## Preparing to Teach - JSM 2022

Washington, DC

### Speakers

Beth Chance, Ciaran Evans, Jo Hardin, Yue Jiang, Jessie Oehrlein, Sara Stoudt, Maria Tackett, and Allison Theobold
...
- Session 1: Teaching-focused careers
- Session 2: Your first year as faculty / early career faculty
- Session 3: GAISE recommendations, teaching intro stats and assessing learning
- Session 4: Teaching intro data science and assessing learning
- Session 5: Mentoring undergraduate researchers

### Materials

Materials from PTT 2022 can be found [here](https://github.com/mine-cetinkaya-rundel/preparing-to-teach/releases/tag/ptt-2022).
